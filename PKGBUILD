...
makedepends=(clang
             ...
             # Using system nodejs instead of nodejs-lts-iron to avoid conflict with existing installation.
             nodejs
             npm
             patchutils
             pciutils
...
source=("git+https://github.com/electron/electron.git?depth=1#tag=v$pkgver"
        ...
        chromium-mirror::git+https://github.com/chromium/chromium.git?depth=1#tag=142.0.7444.265
...
prepare() {
  ...
  # Fix SYS_SECCOMP collision with glibc 2.43+
